                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model.defer="name_ar"  id="name_ar" class="form-control @error('name_ar') is-invalid @enderror">
                                            @error('name_ar')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model.defer="name_en"  id="name_en" class="form-control @error('name_en') is-invalid @enderror">
                                            @error('name_en')
                                              <div class="invalid-feedback">
                                                  {{ $message }}
                                              </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer="active" id="active" class="form-control @error('active') is-invalid @enderror">
